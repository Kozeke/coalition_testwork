<template>
  <form @keydown.esc="isShowingForm=false"  ref="formRef" @submit.prevent="onSubmit()" v-if="isShowingForm" class="p-3 bg-gray-200 rounded-md" action="">
    <input v-model="form.name" ref="inputNameRef" type="text" placeholder="Enter list name..."
